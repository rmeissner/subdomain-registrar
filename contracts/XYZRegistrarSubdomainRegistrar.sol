 ...
 */
contract XYZRegistrarSubdomainRegistrar is AbstractSubdomainRegistrar {
    
    // namehash('xyz')
    bytes32 constant public TLD_NODE = 0xa87a11c7f15e38a7398517fda2ae1b40d870aa24b34b4b09aa09afc71f2c9d26;
    ...
    function configureDomainFor(string memory name, uint price, uint referralFeePPM, address payable _owner, address _transfer) public owner_only(keccak256(bytes(name))) {
        ...
        // require ownership of domain
        bytes32 domainNode = keccak256(abi.encodePacked(TLD_NODE, label));
        require(ens.owner(domainNode) == address(this));
